...
namespace PersonLibrary
{
	...
	public class Child : PersonBase
	{
		...
		/// </summary>
		public Child() : this("Чингисхан", "Линдеманн", 3, Gender.Male,
			null, null, null)
		{ }
		...
		{
			string infoMother = Mother.LastName + " " + Mother.FirstName;
			string infoFather = Father.LastName + " " + Father.FirstName;
