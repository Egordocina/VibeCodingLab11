...
namespace View
{
    ...
    partial class MainForm
    {
		...
		private void InitializeComponent()
		{
			...
			employeesDataGridView.Location = new Point(14, 55);
			...
			employeesDataGridView.Size = new Size(796, 508);
			...
			addButton.Location = new Point(14, 580);
			...
			searchButton.Location = new Point(219, 580);
			...
			saveButton.Location = new Point(422, 580);
			...
			loadButton.Location = new Point(626, 580);
			...
			pictureBox1.Location = new Point(24, 587);
			...
			pictureBox3.Location = new Point(233, 587);
			...
			pictureBox4.Location = new Point(432, 587);
			...
			pictureBox5.Location = new Point(636, 587);
			...
			Text = "Список гонщиков в лыжной команде \"Сутулые псы\"";
