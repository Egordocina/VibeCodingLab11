...
namespace UnitTests.Model
{
    ...
    public class EmployeeBaseTest
    {
        ...
        /// <summary>
        /// Тестирование валидации maxLength для свойства Name (max = 50).
        /// </summary>
        [Test]
        [TestCase(50, TestName = "Тестирование Name при длине ровно 50 символов.")]
        [TestCase(49, TestName = "Тестирование Name при длине 49 символов (max-1).")]
        ...
        [Test]
        [TestCase(51, TestName = "Тестирование Name при длине 51 символ (max+1).")]
        [TestCase(100, TestName = "Тестирование Name при длине 100 символов.")]
        [TestCase(1000, TestName = "Тестирование Name при очень длинном имени.")]
        public void NameTest_MaxLength_Exceeds_ThrowsException(int length)
        {
            var employee = new HourlyEmployee();
            var name = new string('A', length);
            Assert.Throws<IncorrectArgumentException>(() => employee.Name = name);
        ...
        /// <summary>
        /// Тестирование валидации maxLength для свойства LastName (max = 50).
        /// </summary>
        [Test]
        [TestCase(50, TestName = "Тестирование LastName при длине ровно 50 символов.")]
        [TestCase(49, TestName = "Тестирование LastName при длине 49 символов (max-1).")]
        public void LastNameTest_MaxLength_ValidEdge(int length)
        {
            var employee = new HourlyEmployee();
        ...
        [Test]
        [TestCase(51, TestName = "Тестирование LastName при длине 51 символ (max+1).")]
        [TestCase(100, TestName = "Тестирование LastName при длине 100 символов.")]
        public void LastNameTest_MaxLength_Exceeds_ThrowsException(int length)
        {
            var employee = new HourlyEmployee();
            var lastName = new string('A', length);
            Assert.Throws<IncorrectArgumentException>(() => employee.LastName = lastName);
        ...
        /// <summary>
        /// Тестирование валидации maxLength для свойства Country (max = 63).
        /// </summary>
        [Test]
        [TestCase(63, TestName = "Тестирование Country при длине ровно 63 символа.")]
        [TestCase(62, TestName = "Тестирование Country при длине 62 символа (max-1).")]
        public void CountryTest_MaxLength_ValidEdge(int length)
        {
            var employee = new HourlyEmployee();
        ...
        [Test]
        [TestCase(64, TestName = "Тестирование Country при длине 64 символа (max+1).")]
        [TestCase(100, TestName = "Тестирование Country при очень длинной стране.")]
        public void CountryTest_MaxLength_Exceeds_ThrowsException(int length)
        {
            var employee = new HourlyEmployee();
            var country = new string('A', length);
            Assert.Throws<IncorrectArgumentException>(() => employee.Country = country);
        ...
        /// </summary>
        [Test]
        [TestCase(100.0, 10, 1000.0, TestName = "Тестирование Salary при стандартных значениях (целое).")]
        [TestCase(100.0, 3, 300.0, TestName = "Тестирование Salary при 100 * 3.")]
        ...
        /// <summary>
        /// Тестирование свойства TypeName для всех наследников.
        /// </summary>
        [Test]
        [TestCase("Почасовая", TestName = "Тестирование TypeName для HourlyEmployee.")]
        public void TypeNameTest_HourlyEmployee(string expected)
        {
            var employee = new HourlyEmployee();
        ...
        [Test]
        [TestCase("С комиссией", TestName = "Тестирование TypeName для CommissionEmployee.")]
        public void TypeNameTest_CommissionEmployee(string expected)
        {
        ...
        public void TypeNameTest_SalariedEmployee(string expected)
        {
