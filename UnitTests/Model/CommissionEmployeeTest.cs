...
namespace UnitTests.Model
{
	...
	public class CommissionEmployeeTest
	{
		...
		[TestCase(
			10000.0,
			TestName =
				"Тестирование BaseSalary " +
				"при присваивании корректной зарплаты."
		)]
		[TestCase(
			1.0,
			TestName =
				"Тестирование BaseSalary " +
				"при присваивании минимальной зарплаты."
		)]
		[TestCase(
			50000.0,
			TestName =
				"Тестирование BaseSalary " +
				"при присваивании большой зарплаты."
		)]
		[TestCase(
			100.5,
			TestName =
				"Тестирование BaseSalary " +
				"при присваивании дробной зарплаты."
		)]
		[TestCase(
			99999.99,
			TestName =
				"Тестирование BaseSalary " +
				"при присваивании максимальной дробной зарплаты."
		)]
		...
		[TestCase(
			0,
			TestName =
				"Тестирование BaseSalary при присваивании 0."
		)]
		[TestCase(
			-1,
			TestName =
				"Тестирование BaseSalary при присваивании -1."
		)]
		[TestCase(
			-1000,
			TestName =
		...
		public void BaseSalaryTest_InvalidValues_ThrowsException(
			double salary)
		{
			var employee = new CommissionEmployee();
		...
		[TestCase(
			0,
			TestName =
				"Тестирование CommissionRate при присваивании 0."
		)]
		[TestCase(
			-1,
			TestName =
				"Тестирование CommissionRate при присваивании -1."
		)]
		[TestCase(
			-50,
			TestName =
		...
		[TestCase(
			...
			TestName =
				"Тестирование CommissionRate " +
				"при присваивании больше 100%."
		)]
		public void
			CommissionRateTest_InvalidValues_ThrowsException(
				double rate)
		{
			var employee = new CommissionEmployee();
			Assert.Throws<IncorrectArgumentException>(
		...
		[TestCase(
			1000.0,
			TestName =
				"Тестирование BonusAmount " +
				"при присваивании корректного бонуса."
		)]
		[TestCase(
			1.0,
			TestName =
				"Тестирование BonusAmount " +
				"при присваивании минимального бонуса."
		)]
		[TestCase(
			50000.0,
			TestName =
				"Тестирование BonusAmount " +
				"при присваивании большого бонуса."
		)]
		[TestCase(
			100.5,
			TestName =
				"Тестирование BonusAmount " +
				"при присваивании дробного бонуса."
		)]
		[TestCase(
			99999.99,
			TestName =
				"Тестирование BonusAmount " +
				"при присваивании максимального дробного бонуса."
		)]
		...
		[TestCase(
			0,
			TestName =
				"Тестирование BonusAmount при присваивании 0."
		)]
		[TestCase(
			-1,
			TestName =
				"Тестирование BonusAmount при присваивании -1."
		)]
		[TestCase(
			-1000,
			TestName =
		...
		public void BonusAmountTest_InvalidValues_ThrowsException(
			double bonus)
		{
			var employee = new CommissionEmployee();
			Assert.Throws<IncorrectArgumentException>(
		...
		/// Формула: BaseSalary +
		/// (CommissionRate * BonusAmount / 100)
		/// </summary>
		[Test]
		[TestCase(
			10000.0, 10.0, 5000.0, 10500.0,
			TestName =
				"Тестирование CalculateSalary " +
				"при стандартных значениях."
		)]
		[TestCase(
			1000.0, 1.0, 1000.0, 1010.0,
			TestName =
				"Тестирование CalculateSalary " +
				"при минимальных значениях."
		)]
		[TestCase(
			50000.0, 100.0, 50000.0, 100000.0,
			TestName =
				"Тестирование CalculateSalary " +
				"при максимальных значениях."
		)]
		[TestCase(
			20000.0, 25.0, 8000.0, 22000.0,
			TestName =
				"Тестирование CalculateSalary " +
				"при 25% комиссии."
		)]
		[TestCase(
			30000.0, 50.0, 10000.0, 35000.0,
			TestName =
				"Тестирование CalculateSalary " +
				"при 50% комиссии."
		)]
