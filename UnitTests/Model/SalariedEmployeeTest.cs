...
namespace UnitTests.Model
{
	...
	public class SalariedEmployeeTest
	{
		...
		/// <summary>
		/// Тестирование валидации maxLength для свойства
		/// Position (max = 100).
		/// </summary>
		[Test]
		[TestCase(
		...
		public void CalculateSalaryTest_ValidPositions(
			string position, double expectedSalary)
		{
			var employee = new SalariedEmployee
			{
				Position = position
		...
		[TestCase(
			...
			TestName =
				"Тестирование CalculateSalary " +
				"при неизвестном разряде."
		)]
		[TestCase(
			"Стажер",
			TestName =
				"Тестирование CalculateSalary " +
				"при несуществующем разряде."
		)]
		[TestCase(
			"Директор",
			TestName =
				"Тестирование CalculateSalary " +
				"при несуществующей должности."
		)]
		[TestCase(
			"6 разряд",
			TestName =
				"Тестирование CalculateSalary " +
				"при несуществующем 6 разряде."
		)]
		public void
			CalculateSalaryTest_InvalidPositionsThrows(
				string position)
		{
			var employee = new SalariedEmployee
			{
		...
		[TestCase(
			null,
			TestName =
				"Тестирование Position при null."
		)]
		[TestCase(
			"",
			TestName =
				"Тестирование Position при пустой строке."
		)]
		[TestCase(
			"   ",
			TestName =
				"Тестирование Position " +
				"при строке из пробелов."
		)]
		public void
		...
		public void SalaryTest_Rounding(
			string position, double expected)
		{
			var employee = new SalariedEmployee
			{
				Position = position
